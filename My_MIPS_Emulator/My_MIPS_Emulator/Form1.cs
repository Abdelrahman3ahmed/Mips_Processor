    ...
    public partial class Form1 : Form
    {
        ...
        private void runCycleBtn_Click(object sender, EventArgs e)
        {
            ...
            if (cycle <= numofcycles)
            {
                ...
                PiplineGrid.Rows.Add("ID_EX Func", m.ID_EX[7]);
                PiplineGrid.Rows.Add("ID_EX OP_Code", m.ID_EX[8]);
                ...
                PiplineGrid.Rows.Add("EX_MEM Func", m.EX_MEM[6]);
                PiplineGrid.Rows.Add("EX_MEM OP_Code", m.EX_MEM[7]);




                PiplineGrid.Rows.Add("MEM_WB MemToReg", m.EX_MEM[0].Substring(0, 1));
                PiplineGrid.Rows.Add("MEM_WB RegWrite", m.EX_MEM[0].Substring(1, 1));
                PiplineGrid.Rows.Add("MEM_WB Memory Read data", m.EX_MEM[1]);
                PiplineGrid.Rows.Add("MEM_WB ALU Result", m.EX_MEM[2]);
                PiplineGrid.Rows.Add("MEM_WB MUX_RegDst Output", m.EX_MEM[3]);
                PiplineGrid.Rows.Add("MEM_WB Func", m.MEM_WB[4]);
                PiplineGrid.Rows.Add("MEM_WB OP_Code", m.MEM_WB[5]);
